...
else
{
	...
	$conn->query($query);
	$query="create table story(identifier int not null,author varchar(25),title varchar(25),sum_of_ratings_so_far int,number_of_ratings_so_far int,views int,submissiondate date,primary key(identifier))";
	$conn->query($query);
